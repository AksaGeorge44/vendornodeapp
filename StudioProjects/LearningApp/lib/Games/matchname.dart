...
class _MatchingGameState extends State<MatchingGame> {
  List<List<Animal>> animalSets = [
    [
      Animal(name: 'Lion', imagePath: 'assets/images/lion.png'),
      Animal(name: 'Elephant', imagePath: 'assets/images/elephant.png'),
      Animal(name: 'Cat', imagePath: 'assets/images/cat.png'),
      Animal(name: 'Goat', imagePath: 'assets/images/goat.png'),
    ],
  ];

...
class _GuessingGame1State extends State<GuessingGame1> {
  ...
  List<Animal> birds = [
    Animal(name: 'Sparrow', imagePath: 'assets/images/sparrow.png', points: 1),
    Animal(name: 'Parrot', imagePath: 'assets/images/parrot.png', points: 1),
    Animal(name: 'Pigeon', imagePath: 'assets/images/pigeon.png', points: 1),
    Animal(name: 'Owl', imagePath: 'assets/images/owl.png', points: 1),
  ];

...
class _GuessingGameState extends State<GuessingGame> {
  ...
  List<Animal> animals = [
    Animal(name: 'Lion', imagePath: 'assets/images/lion.png', points: 1),
    Animal(name: 'Elephant', imagePath: 'assets/images/elephant.png', points: 1),
    Animal(name: 'Cat', imagePath: 'assets/images/cat.png', points: 1),
    Animal(name: 'Goat', imagePath: 'assets/images/goat.png', points: 1),
  ];

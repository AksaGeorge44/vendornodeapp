...
class DogCheclistPage extends StatelessWidget {
  const DogCheclistPage({super.key});
...
"Food dish,Water bowl,Toys, toys and more toys, including safe chew toys,Brush & comb for grooming, including flea comb,Collar with license and ID tag,Leash,Carrier (for smaller dogs),Training crate,Dog bed or box with warm blanket or towel,Dog toothbrush")
              )),
              SizedBox(
                height: 40,
              ),

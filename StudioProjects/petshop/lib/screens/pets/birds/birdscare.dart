...
import 'package:petshop/screens/pets/birds/birdinteraction.dart';
import 'package:petshop/screens/pets/birds/generalcare.dart';
import 'package:petshop/screens/pets/birds/intelligence.dart';
...
class BirdsCarePage extends StatefulWidget {
  const BirdsCarePage({super.key});

  @override
  State<BirdsCarePage> createState() => _BirdsCarePageState();
}

class _BirdsCarePageState extends State<BirdsCarePage> {
  ...
  switch (index) {
    case 0:
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const BirdsGeneralPage()));

      // Navigate to ExercisePage
      break;
    case 1:
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const BirdInteractionPage()));
    ...
    case 2:
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => const BirdIntelligencePage()));
      break;
    case 3:
      Navigator.push(context,

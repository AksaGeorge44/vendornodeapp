...
class HenCarePage extends StatefulWidget {
  const HenCarePage({super.key});

  @override
  State<HenCarePage> createState() => _HenCarePageState();
}

class _HenCarePageState extends State<HenCarePage> {
...
void navigateToPage(int index, context) {
  switch (index) {
    ...
    case 1:
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const HenClean()));

      // Navigate to GroomingPage
      break;
    case 2:
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const HenClean1()));
          break;
    case 3:
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const HenClean2()));
    break;
    case 4:
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const HenClean3()));
          break;
    case 5:
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const HenClean3()));

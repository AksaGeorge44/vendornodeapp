...
class _DoctorAddState extends State<DoctorAdd> {
  ...
  TextEditingController password = TextEditingController();
   ...
   Future <void> _saveDataToFirebase() async{
    ...
    CollectionReference doctorCollection = firestore.collection('adddoctor');
...
Future<void> _openImagePicker(ImageSource source) async {
  ...
  Widget build(BuildContext context) {
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const Center(child: Text("BASIC FORM",style: TextStyle(
                  fontSize: 40,
    ...
    // Navigate to the AppointmentListPage to display the fetched data
                        ...
                        child: const Text("Register Doctor",style: TextStyle(
                          fontSize: 20
                        ),)),

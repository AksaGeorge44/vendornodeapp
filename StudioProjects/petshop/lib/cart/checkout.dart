...
import 'package:petshop/firebase_helper/firebase_firestore_helper.dart';
import 'package:petshop/firebase_helper/prodctmodel.dart';
import 'package:petshop/screens/homepage.dart';
import 'package:petshop/model/provider.dart';
import 'package:petshop/model/routes.dart';
import 'package:petshop/cart/stripehelper.dart';
...
class _CheckOutState extends State<CheckOut> {
  ...
  Widget build(BuildContext context) {
      ...
      const SizedBox(height: 50,),
        ...
        decoration: BoxDecoration(
          ...
          //Text("Pay Online"),
            ...
            TextButton(child: const Text("Continue"),onPressed: ()async{
    ...
    widget: const HomePage(), context: context, arguments: appProvider.totalPrice());
    });
    }
    } else {

...
import 'package:petshop/petProducts/cages/catcages.dart';
import 'package:petshop/petProducts/cages/dogcages.dart';
import 'package:petshop/petProducts/cages/duckcage.dart';
import 'package:petshop/petProducts/cages/fishbowl.dart';
import 'package:petshop/petProducts/cages/hencage.dart';
import 'package:petshop/petProducts/cages/rabbitcage.dart';
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                   context,
                                   MaterialPageRoute(
                                       builder: (context) => const DogCagePage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                               Navigator.push(
                                   context,
                                   MaterialPageRoute(
                                       builder: (context) => const CatCagePage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                               Navigator.push(
                                   context,
                                   MaterialPageRoute(
                                       builder: (context) => const FishBowlPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                   context,
                                   MaterialPageRoute(
                                     builder: (context) => const RabbitCagePage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                   context,
                                   MaterialPageRoute(
                                       builder: (context) => const DuckCagePage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                   context,
                                   MaterialPageRoute(
                                      builder: (context) => const HenCagePage()));
                            },

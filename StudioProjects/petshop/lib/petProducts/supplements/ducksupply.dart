...
class DuckSupplyPage extends StatefulWidget {
  const DuckSupplyPage({super.key});

  @override
  State<DuckSupplyPage> createState() => _DuckSupplyPageState();
}

class _DuckSupplyPageState extends State<DuckSupplyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Duck Supplements"),
      ),

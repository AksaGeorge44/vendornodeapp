...
class PuppySupplyPage extends StatefulWidget {
  const PuppySupplyPage({super.key});

  @override
  State<PuppySupplyPage> createState() => _PuppySupplyPageState();
}

class _PuppySupplyPageState extends State<PuppySupplyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Puppy Supplyments"),
      ),

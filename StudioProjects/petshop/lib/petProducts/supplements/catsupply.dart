...
class CatSupplyPage extends StatefulWidget {
  const CatSupplyPage({super.key});

  @override
  State<CatSupplyPage> createState() => _CatSupplyPageState();
}

class _CatSupplyPageState extends State<CatSupplyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Cat Supplements"),
      ),

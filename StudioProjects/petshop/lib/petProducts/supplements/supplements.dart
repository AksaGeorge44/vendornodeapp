...
import 'package:petshop/petProducts/supplements/birdssupply.dart';
import 'package:petshop/petProducts/supplements/catsupply.dart';
import 'package:petshop/petProducts/supplements/dogsupply.dart';
import 'package:petshop/petProducts/supplements/ducksupply.dart';
import 'package:petshop/petProducts/supplements/fishsupply.dart';
import 'package:petshop/petProducts/supplements/hensuppl.dart';
import 'package:petshop/petProducts/supplements/kittensupply.dart';
import 'package:petshop/petProducts/supplements/puppysupply.dart';
import 'package:petshop/petProducts/supplements/rabbitsupply.dart';
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const DogSupplyPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const PuppySupplyPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const CatSupplyPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const KittenSupplyPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const BirdsSupplyPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const FishSupplyPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const RabbitSupplyPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const DuckSupplyPage()));
                            },
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const HenSupplyPage()));
                            },

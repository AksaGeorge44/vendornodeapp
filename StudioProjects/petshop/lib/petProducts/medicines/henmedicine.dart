...
class HenMedicinePage extends StatefulWidget {
  const HenMedicinePage({super.key});

  @override
  State<HenMedicinePage> createState() => _HenMedicinePageState();
}

class _HenMedicinePageState extends State<HenMedicinePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Hen Medicines"),
      ),
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Text(
              "Pick For Pet",
              style: TextStyle(fontSize: 22, color: Color.fromARGB(255, 209, 132, 223)),
            ),
            const SizedBox(
              height: 10,
            ),
